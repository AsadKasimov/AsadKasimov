...
:heavy_check_mark: Реализованы автотесты UI на проверку элементов главной страницы интернет магазина look.online, а также поиск заданной категории одежды.</br></br>
...
:link: Тестовый проект: <a target="_blank" href="https://github.com/ElenaSkorobodilova/open-library-api-tests">СКОРО</a></br></br><p  align="center">
  <code><img width="5%" title="Python" src="./images/icons/Python-logo-notext.svg"></code>
  <code><img width="5%" title="PyCharm" src="./images/icons/pycharm.svg"></code>
  <code><img width="6%" title="PyCharm" src="./images/icons/pytest.png"></code>
  <code><img width="6%" title="PyCharm" src="./images/icons/selene.png"></code>
